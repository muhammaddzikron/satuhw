export type UserRole = 'umum' | 'umum_pandu' | 'kwarda' | 'sugli' | 'sugli_daerah' | 'sugli_wilayah' | 'admin_kwarda' | 'jati1' | 'jayamelati1' | 'jati2' | 'jayamelati2' | 'jari1' | 'jayamatahari1' | 'jari2' | 'jayamatahari2' | 'jawi' | 'jayapertiwi' | 'admin' | 'superadmin' | 'admin_diklat' | 'diklat' | 'pelatih';
